# Threat Model: K2 Authorization

## Component
**Module:** K2 Authorization
**Description:** RBAC/ABAC policy engine
...
- **elevation-of-privilege**: Identified and mitigated through constitutional controls
- **unauthorized-access**: Identified and mitigated through constitutional controls
